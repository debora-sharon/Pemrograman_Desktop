...
Public Class frmUtama
    ...
    '    Dim harga As Integer = 0
    '    Dim nomor As String = String.Empty
    '    Dim selectedItemText As String = cbJenis.SelectedItem.ToString()
    ...
    Private Sub Form1_KeyDown(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
        ...
        If selectedItemText = "Motor" Then
            jns = "Motor"
        ElseIf selectedItemText = "Mobil" Then
            jns = "Mobil"
        ElseIf selectedItemText = "Taksi" Then
            jns = "Taksi/Umum"
        ElseIf selectedItemText = "Sepeda" Then
            jns = "Sepeda"
        ElseIf selectedItemText = "Bus/Truk" Then
            jns = "Bus/Truk"
        End If
        ...
        If e.KeyCode = Keys.Return Then
            ...
            Else 'kalau belum ada masukkan baru
                If jns = String.Empty Then
                    ...
                    Exit Sub
                End If
                sql = "insert into tblparkir(no_plat,jenis,user) values ('" & txtNoPlat.Text.ToUpper & "','" & selectedItemText & "','" & pengguna & "')"
                If hasil1.IsClosed = False Then
                    hasil1.Close()
                End If
                myCommand.CommandText = sql
    ...
    Private Sub ToolStripMenuDelete_Click(sender As Object, e As EventArgs) Handles ToolStripMenuDelete.Click

Public Class frmUtama
    ...
    Private Sub GreyscaleToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles GreyscaleToolStripMenuItem.Click
        If PictureBox1.Image Is Nothing Then
            MessageBox.Show("Silakan buka citra terlebih dahulu sebelum melakukan pengolahan.", "Peringatan", MessageBoxButtons.OK, MessageBoxIcon.Warning)
            Exit Sub
        Else
    ...
    'End Sub
    Private Sub FlipHorizontalToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles FlipHorizontalToolStripMenuItem.Click
        Dim originalBmp As Bitmap = New Bitmap(PictureBox1.Image)
        ...
        For y As Integer = 0 To height - 1
            For x As Integer = 0 To width - 1
                Dim pixelColor As Color = originalBmp.GetPixel(x, y)
                flippedBmp.SetPixel(width - x - 1, y, pixelColor)
            Next
        Next
        ...
        For bar As Integer = 1 To PictureBox1.Image.Height - 2
            For kol As Integer = 1 To PictureBox1.Image.Width - 2
                ...
                For i As Integer = 0 To 8
                    ...
                    b += kernel(i) * px.B
                Next
                r = Math.Min(Math.Max(r + 128, 0), 255) ' Shift untuk nilai tengah
